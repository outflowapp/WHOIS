...
var grammarRegexes = {
  'id': [/Domain ID:[ ]*(.+)/i],
  'status': [/\[Status\]\s*(.+)/i, /Status\s*:\s?(.+)/i, /\[State\]\s*(.+)/i, /^state:\s*(.+)/i],
  'creation_date': [/\[Created on\]\s*(.+)/i, /Created on[.]*: [a-zA-Z]+, (.+)/i, /Creation Date:\s?(.+)/i, /Creation date\s*:\s?(.+)/i, /Registration Date:\s?(.+)/i, /Created Date:\s?(.+)/i, /Created on:\s?(.+)/i, /Created on\s?[.]*:\s?(.+)\./i, /Date Registered\s?[.]*:\s?(.+)/i, /Domain Created\s?[.]*:\s?(.+)/i, /Domain registered\s?[.]*:\s?(.+)/i, /Domain record activated\s?[.]*:\s*?(.+)/i, /Record created on\s?[.]*:?\s*?(.+)/i, /Record created\s?[.]*:?\s*?(.+)/i, /Created\s?[.]*:?\s*?(.+)/i, /Registered on\s?[.]*:?\s*?(.+)/i, /Registered\s?[.]*:?\s*?(.+)/i, /Domain Create Date\s?[.]*:?\s*?(.+)/i, /Domain Registration Date\s?[.]*:?\s*?(.+)/i, /created:\s*(.+)/i, /\[Registered Date\]\s*(.+)/i, /created-date:\s*(.+)/i, /Domain Name Commencement Date: (.+)/i, /registered:\s*(.+)/i, /registration:\s*(.+)/i],
  'expiration_date': [/\[Expires on\]/i, /Registrar Registration Expiration Date:[ ]*(.+)-[0-9]{4}/i, /Expires on[.]*: [a-zA-Z]+, (.+)/i, /Expiration Date:\s?(.+)/i, /Expiration date\s*:\s?(.+)/i, /Expires on:\s?(.+)/i, /Expires on\s?[.]*:\s?(.+)\./i, /Exp(?:iry)? Date\s?[.]*:\s?(.+)/i, /Expiry\s*:\s?(.+)/i, /Domain Currently Expires\s?[.]*:\s?(.+)/i, /Record will expire on\s?[.]*:\s?(.+)/i, /Domain expires\s?[.]*:\s*?(.+)/i, /Record expires on\s?[.]*:?\s*?(.+)/i, /Record expires\s?[.]*:?\s*?(.+)/i, /Expires\s?[.]*:?\s*?(.+)/i, /Expire Date\s?[.]*:?\s*?(.+)/i, /Expired\s?[.]*:?\s*?(.+)/i, /Domain Expiration Date\s?[.]*:?\s*?(.+)/i, /paid-till:\s*(.+)/i, /expiration_date:\s*(.+)/i, /expire-date:\s*(.+)/i, /renewal:\s*(.+)/i, /expire:\s*(.+)/i],
  'updated_date': [/\[Last Updated\]\s*(.+)/i, /Record modified on[.]*: (.+) [a-zA-Z]+/i, /Record last updated on[.]*: [a-zA-Z]+, (.+)/i, /Updated Date:\s?(.+)/i, /Updated date\s*:\s?(.+)/i, /Record last updated on\s?[.]*:?\s?(.+)\./i, /Domain record last updated\s?[.]*:\s*?(.+)/i, /Domain Last Updated\s?[.]*:\s*?(.+)/i, /Last updated on:\s?(.+)/i, /Date Modified\s?[.]*:\s?(.+)/i, /Last Modified\s?[.]*:\s?(.+)/i, /Domain Last Updated Date\s?[.]*:\s?(.+)/i, /Record last updated\s?[.]*:\s?(.+)/i, /Modified\s?[.]*:\s?(.+)/i, /(?:C|c)hanged:\s*(.+)/i, /last_update:\s*(.+)/i, /Last Update\s?[.]*:\s?(.+)/i, /Last updated on (.+) [a-z]{3,4}/i, /Last updated:\s*(.+)/i, /last-updated:\s*(.+)/i, /\[Last Update\]\s*(.+) \([A-Z]+\)/i, /Last update of whois database:\s?[a-z]{3}, (.+) [a-z]{3,4}/i],
  'registrar': [/registrar:\s*(.+)/i, /Registrar:\s*(.+)/i, /Sponsoring Registrar Organization:\s*(.+)/i, /Registered through:\s?(.+)/i, /Registrar Name[.]*:\s?(.+)/i, /Record maintained by:\s?(.+)/i, /Registration Service Provided By:\s?(.+)/i, /Registrar of Record:\s?(.+)/i, /Domain Registrar :\s?(.+)/i, /Registration Service Provider: (.+)/i, /\tName:\t\s(.+)/i],
  'whois_server': [/Whois Server:\s?(.+)/i, /Registrar Whois:\s?(.+)/i],
  'nameservers': [/Name Server:[ ]*([^ ]+)/i, /Nameservers:[ ]*([^ ]+)/i, /nameserver:\s*(.+)/i, /nserver:\s*([^[\s]+)/i, /Name Server[.]+ ([^[\s]+)/i, /Hostname:\s*([^\s]+)/i, /DNS[0-9]+:\s*(.+)/i, /   DNS:\s*(.+)/i, /ns[0-9]+:\s*(.+)/i, /NS [0-9]+\s*:\s*(.+)/i, /\[Name Server\]\s*(.+)/i, /Nserver:\s*(.+)/i],
  'emails': [/([\w.-]+@[\w.-]+\.[\w]{2,6})/i, /([\w.-]+\sAT\s[\w.-]+\sDOT\s[\w]{2,6})/i]
};

var registrantPatterns = ["   Registrant:[ ]*\n      (?P<organization>.*)\n      (?P<name>.*)\n      (?P<street>.*)\n      (?P<city>.*), (?P<state>.*) (?P<postalcode>.*)\n      (?P<country>.*)\n(?:      Phone: (?P<phone>.*)\n)?      Email: (?P<email>.*)\n", // Corporate Domains, Inc.
"Registrant:\n  (?P<name>.+)\n  (?P<street1>.+)\n(?:  (?P<street2>.*)\n)?(?:  (?P<street3>.*)\n)?  (?P<postalcode>.+), (?P<city>.+)\n  (?P<country>.+)\n  (?P<phone>.+)\n  (?P<email>.+)\n\n", // OVH
...
var techContactPatterns = ["   Technical Contact:[ ]*\n      (?P<organization>.*)\n      (?P<name>.*)\n      (?P<street>.*)\n      (?P<city>.*), (?P<state>.*) (?P<postalcode>.*)\n      (?P<country>.*)\n(?:      Phone: (?P<phone>.*)\n)?      Email: (?P<email>.*)\n", //Corporate Domains, Inc.
"Technical Contact:\n  (?P<name>.+)\n  (?P<street1>.+)\n(?:  (?P<street2>.*)\n)?(?:  (?P<street3>.*)\n)?  (?P<postalcode>.+), (?P<city>.+)\n  (?P<country>.+)\n  (?P<phone>.+)\n  (?P<email>.+)\n\n", //OVH
...
var adminContactPatterns = ["   Administrative Contact:[ ]*\n      (?P<organization>.*)\n      (?P<name>.*)\n      (?P<street>.*)\n      (?P<city>.*), (?P<state>.*) (?P<postalcode>.*)\n      (?P<country>.*)\n(?:      Phone: (?P<phone>.*)\n)?      Email: (?P<email>.*)\n", //Corporate Domains, Inc.
...
var contanctAttributes = ['name', 'handle', 'email', 'phone', 'fax', 'organization', 'country', 'city', 'state', 'postalcode', 'district', 'street', 'street1', 'street2', 'street3'];

var registrantXRegexes = registrantPatterns.map(function (pattern) {
  return (0, _xregexp2.default)(pattern);
});
var techContactXRegexes = techContactPatterns.map(function (pattern) {
  return (0, _xregexp2.default)(pattern);
});
var adminContactXRegexes = adminContactPatterns.map(function (pattern) {
  return (0, _xregexp2.default)(pattern);
});
var billingContactXRegexes = billingContactPatterns.map(function (pattern) {
  return (0, _xregexp2.default)(pattern);
});

var extractContact = function extractContact(data, xRegexes) {
  var result = {};

  var _loop = function _loop(i) {
    var match = _xregexp2.default.exec(data, xRegexes[i]);
    if (match) {
      contanctAttributes.map(function (attr) {
        if (match[attr]) {
  ...
  for (var i = 0; i < xRegexes.length; i++) {
    var _ret = _loop(i);
...
var parse = function parse(data) {
  ...
  if (data) {
    data.split("\n").forEach(function (line) {
      Object.keys(grammarRegexes).forEach(function (key) {
        for (var i = 0; i < grammarRegexes[key].length; i++) {
          var _match = grammarRegexes[key][i].exec(line);
          if (_match) {
            result[key] = _match[1].trim();
            break;
          }
        }
      });
